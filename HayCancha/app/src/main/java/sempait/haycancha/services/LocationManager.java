...
public class LocationManager implements
    ...
    public LocationManager(Context locationActivity) {
    ...
    public static LocationManager getInstance(Context cont) {
        if (instance == null) {
            instance = new LocationManager(cont);
        }
    ...
    public boolean hasLocationError() {
        if (googleApiClient != null && getLocation() == null)
            return true;
        else
            return false;
    }
    ...
    public int getUserLocation() {
        ...
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(locationActivity);
