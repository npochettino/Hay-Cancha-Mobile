...
public class Utils {
    ...
    public static DisplayImageOptions getImageLoaderOptionRouded() {
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder().resetViewBeforeLoading(false)
                .cacheInMemory(false).cacheOnDisk(true).considerExifParams(false).showImageOnLoading(R.drawable.perfil).imageScaleType(ImageScaleType.IN_SAMPLE_POWER_OF_2).bitmapConfig(Bitmap.Config.ARGB_8888).displayer(new RoundedBitmapDisplayer(1000)).handler(new Handler()).build();
